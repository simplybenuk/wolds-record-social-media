...
13. Choose one engagement intent and compatible content structure. Save posts must be reusable; send posts identify a relevant recipient; comment prompts ask a safe non-clinical question; follow posts promise specific future Record content; enquiry copy uses only confirmed product facts.
14. Use photography as a meaningful primary or framed visual when selected, not as a uniformly pale watermark. The final slide must complete the idea and carry the same specific CTA stored on the post.
