...
const fixtureContent: Record<string, { title: string; headlines: string[]; body: string; instagram: string; facebook: string; altPrefix: string }> = {
  ...
  academy: { title: "Practical learning for canine wellbeing", headlines: ["Save this simple learning checklist", "What would you like to understand next?", "Follow for practical canine learning ideas", "Send this to someone learning about canine wellbeing", "Ask which learning route fits your goal", "Build understanding one useful step at a time"], body: "Practical, flexible learning gives dog guardians and developing practitioners room to build understanding step by step.", instagram: "Useful learning makes space for questions. Start with one clear idea and build your canine massage knowledge step by step.", facebook: "Practical canine learning can begin with a focused question and develop at a pace that suits the learner.", altPrefix: "Wolds Canine Therapy Academy portrait slide: " },
};
